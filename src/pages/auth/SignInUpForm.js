...
const SignUpForm = () => {
  ...
  <Form.Group controlId="password2">
    ...
    <Form.Control className={styles.Input} type="password" placeholder="Repeat Password" name='password2' value={password2} onChange={handleChange}/>
  </Form.Group>
  <Form.Group controlId="formBasicCheckbox">
    <Form.Check type="checkbox" label="Confirm that you are over 18." />
  </Form.Group>
